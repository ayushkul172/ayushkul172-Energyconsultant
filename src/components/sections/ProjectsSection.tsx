...
function ProjectSlide({ project, index, total, onExpand }: ProjectSlideProps) {
  ...
  return (
    ...
    >
      {/* Top accent bar */}
      <div className={cn('absolute top-0 left-0 right-0 h-1 bg-gradient-to-r', project.accentColor)} />
          ...
          <div className="lg:w-1/2 flex flex-col">
            <div>
              ...
              {isUSCAgent ? (
                ...
                <div className="max-h-[45vh] overflow-y-auto pr-2 custom-scrollbar space-y-3 mb-4">
                ...
                /* Other projects: show situation text */
                <p className="text-[var(--color-text-subtle)] text-sm sm:text-base leading-relaxed mb-5">
                  {project.situation.substring(0, 200)}{project.situation.length > 200 ? '...' : ''}
                </p>
              )}
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="text-xs px-3 py-1.5 rounded-full font-medium bg-white/5 text-[var(--color-text-subtle)] border border-white/10"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="grid grid-cols-3 gap-3">
              {project.results.map((result, i) => (
                ...
                >
                  <span className={cn(
                    'block text-xl sm:text-2xl lg:text-3xl font-bold mb-1',
